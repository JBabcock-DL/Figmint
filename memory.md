...
- **Current sprint folder:** `.github/Sprint 8/` — **In Planning** (WO-039..044 + WO-056; Code Connect + Import Phase 4a). All 7 tickets have full `plan.md` (2026-05-29). Sprint 7 handoff complete (WO-034..038 + WO-059 closed 2026-05-29).

...
- **Current sprint folder:** `.github/Sprint 5/` — **WO-022..025 + WO-027 + WO-057 Completed** (2026-05-28 designer VQA sign-off on doc pipeline). **WO-026** superseded by WO-058 — do not Complete. **WO-056** (#59) roadmap — catalog + batch scaffold (Phase 4a, Context Backlog).

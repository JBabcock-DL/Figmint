...
- **Current sprint folder:** `.github/Sprint 4/` — **WO-016–020 In Planning** (2026-05-28); **WO-021 deferred** to Context Backlog. **Single build** — `npm run build`, root `manifest.json`, `src/config/flags.ts` (all features `true`). Plan order: **WO-019 → WO-017 → WO-016 → WO-018 → WO-020** (build sequence).

...
- _2026-05-27 — **Plan quality bar enforced (repo templates; skill untouched).** `.github/templates/plan-quality-bar.md` — plans must be sub-agent-ready and traceable to parent `ticket.md`; wired into `memory.md`, `workflow.md`, `agent-handoff.md`._

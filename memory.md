...
- **Current sprint folder:** `.github/Sprint 5/` — **WO-022–027 In Research** (2026-05-28). Component forward-scaffold path. **Plan order: WO-022 → WO-023/024/025/026 (parallel) → WO-027.** Research index: `.github/Sprint 5/research/sprint-5-component-scaffold-research-index.md`.
...
- _2026-05-28 — **Sprint 5 research complete.** WO-022–027 moved to In Research; six research docs (~2,242 lines total). Locked: single `scaffold()` call, layer naming for bindings, usage frame curation max 6, registry upsert by spec name, `scaffold/run` orchestration for Components tab. Index: `.github/Sprint 5/research/sprint-5-component-scaffold-research-index.md`. Pre-plan spikes SPK-022-1/2 before WO-022 build._
